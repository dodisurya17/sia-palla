<x-app-layout>
    <x-slot name="title">Tambah Ekstrakurikuler</x-slot>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-sm border p-6 mb-6 flex items-center gap-4">
            ...
            <div>
                <h2 class="text-lg font-semibold text-slate-800">Tambah Ekstrakurikuler</h2>
                <p class="text-sm text-slate-500">Lengkapi data kegiatan ekstrakurikuler baru</p>
            </div>
        </div>
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <input type="text" id="nama_ekstrakurikuler" name="nama_ekstrakurikuler"
                            value="{{ old('nama_ekstrakurikuler') }}" placeholder="Contoh: Pramuka"
                    ...
                    <div>
                        ...
                        <input type="text" id="pembina" name="pembina" value="{{ old('pembina') }}"
